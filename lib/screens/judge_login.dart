...
class JudgeLogin extends StatelessWidget {
  const JudgeLogin({super.key});

  @override
  Widget build(BuildContext context) {
    
    final Color bgColor = const Color(0xFF0B1324); 
    final Color cardColor = const Color(0xFF1C2541); 
    final Color orangeBtn = const Color(0xFFE67E22); 
    final Color scoreBg = const Color(0xFF0B2540); 
    final Color yellowBtn = const Color(0xFFF1C40F); 
    final Color redBtn = const Color(0xFFE74C3C); 
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(
                height: MediaQuery.of(context).size.height * 0.5, // Take 50% of screen height
                child: Card(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                _buildSmallButton('Yellow 1', yellowBtn),
                                const SizedBox(width: 8),
                                _buildSmallButton('Yellow 2', yellowBtn),
                                const SizedBox(width: 8),
                                _buildSmallButton('Red', redBtn),
                              ],
                            ),
                          ],
                        ),
